...
pixi add qca qca-qt6
# for installing globally
pixi global install qca qca-qt6
```
...
It is possible to list all of the versions of `qca` available on your platform:
...
```
pixi search qca --channel conda-forge
```
